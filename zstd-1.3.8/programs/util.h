...
U64 UTIL_getTotalFileSize(const char *const *const fileNamesTable,
                          unsigned nbFiles);
...
int UTIL_prepareFileList(const char *dirName, char **bufStart, size_t *pos,
 ...
 */
const char **UTIL_createFileList(const char **inputNames, unsigned inputNamesNb,
                                 char **allocatedBuffer,
                                 unsigned *allocatedNamesNb, int followLinks);
