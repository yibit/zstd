...
inline file_status
status(StringPiece path, std::error_code &ec) noexcept
{
    file_status status;
#if defined(_MSC_VER)
...
inline bool
is_regular_file(file_status status) noexcept
{
#if defined(S_ISREG)
...
/// http://en.cppreference.com/w/cpp/filesystem/is_regular_file
inline bool
is_regular_file(StringPiece path, std::error_code &ec) noexcept
{
...
inline bool
is_directory(file_status status) noexcept
{
#if defined(S_ISDIR)
...
/// http://en.cppreference.com/w/cpp/filesystem/is_directory
inline bool
is_directory(StringPiece path, std::error_code &ec) noexcept
{
...
file_size(StringPiece path, std::error_code &ec) noexcept
{
