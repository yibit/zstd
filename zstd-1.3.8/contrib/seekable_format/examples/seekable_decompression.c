...
static void
decompressFile_orDie(const char *fname, off_t startOffset, off_t endOffset)
{
    ...
    while (startOffset < endOffset) {
        size_t const result = ZSTD_seekable_decompress(
            seekable, buffOut, MIN(endOffset - startOffset, buffOutSize),
            startOffset);
