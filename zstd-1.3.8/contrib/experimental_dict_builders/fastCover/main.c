...
***************************************/
int
FASTCOVER_trainFromFiles(const char *dictFileName, sampleInfo *info,
                         unsigned maxDictSize, ZDICT_fastCover_params_t *params)
{
...
main(int argCount, const char *argv[])
{
    ...
    operationResult =
        FASTCOVER_trainFromFiles(outputFile, info, maxDictSize, &params);
