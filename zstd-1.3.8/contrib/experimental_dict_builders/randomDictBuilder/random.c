 ...
 */
static size_t
RANDOM_sum(const size_t *samplesSizes, unsigned nbSamples)
{
    size_t sum = 0;
    unsigned i;
 ...
 */
static int
RANDOM_checkParameters(ZDICT_random_params_t parameters, size_t maxDictSize)
{
 ...
 */
static size_t
RANDOM_buildDictionary(const size_t totalSamplesSize, const BYTE *samples,
                       ...
                       ZDICT_random_params_t parameters)
{
    ...
    while (tail > 0) {
        /* Select a segment */
        RANDOM_segment_t segment =
            RANDOM_selectSegment(totalSamplesSize, parameters);
...
ZDICTLIB_API size_t
ZDICT_trainFromBuffer_random(void *dictBuffer, size_t dictBufferCapacity,
                             ...
                             ZDICT_random_params_t parameters)
{
    ...
    {
        const size_t tail =
            RANDOM_buildDictionary(totalSamplesSize, samples, dictBuffer,
