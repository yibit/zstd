...
/* Little endian */
static uint16_t
get_unaligned_le16(const void *memPtr)
{
    uint16_t val;
...
static uint32_t
get_unaligned_le32(const void *memPtr)
{
    uint32_t val;
    memcpy(&val, memPtr, sizeof(val));
    if (!_isLittleEndian())
...
static uint64_t
get_unaligned_le64(const void *memPtr)
{
    uint64_t val;
    memcpy(&val, memPtr, sizeof(val));
    if (!_isLittleEndian())
...
static void
put_unaligned_le16(uint16_t value, void *memPtr)
{
    if (!_isLittleEndian())
        value = _swap16(value);
...
static void
put_unaligned_le32(uint32_t value, void *memPtr)
{
    if (!_isLittleEndian())
        value = _swap32(value);
    memcpy(memPtr, &value, sizeof(value));
...
static void
put_unaligned_le64(uint64_t value, void *memPtr)
{
    if (!_isLittleEndian())
        value = _swap64(value);
    memcpy(memPtr, &value, sizeof(value));
...
/* big endian */
static uint32_t
get_unaligned_be32(const void *memPtr)
{
    uint32_t val;
    memcpy(&val, memPtr, sizeof(val));
    if (_isLittleEndian())
...
static uint64_t
get_unaligned_be64(const void *memPtr)
{
    uint64_t val;
    memcpy(&val, memPtr, sizeof(val));
    if (_isLittleEndian())
...
static void
put_unaligned_be32(uint32_t value, void *memPtr)
{
    if (_isLittleEndian())
        value = _swap32(value);
    memcpy(memPtr, &value, sizeof(value));
...
static void
put_unaligned_be64(uint64_t value, void *memPtr)
{
    if (_isLittleEndian())
        value = _swap64(value);
    memcpy(memPtr, &value, sizeof(value));
