 ...
 * Method 1 : `__packed` statement. It depends on compiler extension (i.e., not
 * portable).
...
MEM_STATIC void
MEM_writeLE24(void *memPtr, U32 val)
{
...
MEM_STATIC void
MEM_writeLE32(void *memPtr, U32 val32)
{
    if (MEM_isLittleEndian())
...
MEM_STATIC void
MEM_writeLE64(void *memPtr, U64 val64)
{
    if (MEM_isLittleEndian())
...
MEM_STATIC void
MEM_writeLEST(void *memPtr, size_t val)
{
    if (MEM_32bits())
...
MEM_STATIC void
MEM_writeBE32(void *memPtr, U32 val32)
{
    if (MEM_isLittleEndian())
        MEM_write32(memPtr, MEM_swap32(val32));
    else
...
MEM_STATIC void
MEM_writeBE64(void *memPtr, U64 val64)
{
    if (MEM_isLittleEndian())
        MEM_write64(memPtr, MEM_swap64(val64));
    else
...
MEM_STATIC size_t
MEM_readBEST(const void *memPtr)
{
    if (MEM_32bits())
...
MEM_STATIC void
MEM_writeBEST(void *memPtr, size_t val)
{
    if (MEM_32bits())
